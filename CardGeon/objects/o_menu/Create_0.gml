...
p_main = new UiPage(10, 
	[
		new UiButton(default_width, default_height, s_nine_slice_default_menu, "Play", function(){
			room_goto(r_battle);
		}),
		
		new UiButton(default_width, default_height, s_nine_slice_default_menu, "Settings", function(){
...
p_settings = new UiPage(10, 
	[
		...
		new UiSlider(128, 32, s_nine_slice_default_menu, s_slider, "SFX",0, 1, 2, global.volume_sfx, function(value){
			global.volume_sfx = value;
			audio_group_set_gain(audiogroup_sfx,value,0);
		}),
		new UiSlider(128, 32, s_nine_slice_default_menu, s_slider, "MUSIC",0, 1, 2, global.volume_music, function(value){
