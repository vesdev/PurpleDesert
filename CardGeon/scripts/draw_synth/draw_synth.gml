...
with o_game.synth_wave { 
	...
	var cam_x =  xx - surf_width/2 + ww/2;
	var cam_y = camera_get_view_y(view_camera[0]) +  yy  - surf_height - 80 + hh/2;
	...
	{
		clipping_mask = surface_create(120, 120);
	}
