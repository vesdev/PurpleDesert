...
function wave3D() constructor
{
	...
	vertex_begin(vb_plane, v_format);
	...
	static Draw = function(saturation)
	{
		...
		camera_set_proj_mat(tempCam, matrix_build_projection_perspective_fov(-45, -view_get_hport(_cam)/view_get_wport(_cam), 1, 99999));
		camera_set_view_mat(tempCam, matrix_build_lookat(0, 0, -999, _s, 0, 0, 0, 1, 0));
